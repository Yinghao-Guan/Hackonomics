...
export const NODES: Record<string, Node> = {
        ...
        choices: [
            {
                ...
                effects: [
                    ...
                    { type: "add", key: "actionPoints", value: -1 },
                    {
                        type: "achievement",
                        id: "ach_prudent_ruler",
                        title: "未雨绸缪",
                        description: "你强制储粮备荒。村民牢骚满腹，但仓库里堆满了应对灾害的储备。凯恩斯主义式的风险防范，代价是民心的短期流失。",
                    },
            ...
            },
            {
                ...
                title: "官方补贴，将小麦转化为肉类",
                effects: [
                    { type: "add", key: "foodStock", value: -30 },
                    { type: "add", key: "happiness", value: 20 },
                    {
                        type: "achievement",
                        id: "ach_utility_maximizer",
                        title: "效用最大化",
                        description: "肉类的香气飘遍全村，幸福度暴涨。但小麦储备大幅削减，下一场灾荒的缓冲期已大为缩短。",
                    },
                    { type: "log", text: "事件二：转化肉类，幸福度暴涨，但粮食储备锐减。" },
                    { type: "goto", nodeId: "event2_ending" },
                ],
            },
            {
                key: "C",
                title: "放开管制，允许村民私自酿酒交易",
                effects: [
                    { type: "add", key: "money", value: 300 },
                    { type: "add", key: "happiness", value: 10 },
                    { type: "add", key: "productivity", value: -8 },
                    {
                        type: "achievement",
                        id: "ach_invisible_hand",
                        title: "看不见的手",
                        description: "黑市自发形成，酒香四溢。金币滚滚而来，但清醒的劳动力却越来越少。奥地利学派的自发秩序，有时候味道像酒。",
                    },
    ...
    season2_end: {
        id: "season2_end", type: "dialogue", speaker: "（系统）", bg: "black",
        text: "【第二季 结束】\n丰收是礼物，也是考验。你的决策将在下一个季节显现它真实的代价。",
        next: "season2_start",
    },
    season2_start: {
        id: "season2_start", type: "dialogue", speaker: "立（Prophet）", avatar: "🐴", bg: "village",
        text: "撑过第二季了。不过，当一个村子富裕起来，新的麻烦也会接踵而至——有人开始想要垄断，有人开始想要偷懒……敬请期待事件三。",
        next: "event3_start",
    },
    ...
    event3_choice: {
        ...
        choices: [
            {
                key: "A",
                title: "铁腕禁伐令，完全禁止河畔伐木",
                effects: [
                    { type: "add", key: "happiness", value: 10 },
                    { type: "add", key: "productivity", value: -15 },
                    { type: "add", key: "gdp", value: -80 },
                    {
                        type: "achievement",
                        id: "ach_iron_fist",
                        title: "铁腕治河",
                        description: "水质恢复，渔民欢呼雀跃。但木材产量暴跌，建筑升级成本急剧上升，经济发展停滞。公共利益至上，代价是发展的脚步。",
                    },
                    { type: "log", text: "事件三：颁布禁伐令，水质恢复，但木材产量暴跌，GDP下滑。" },
                    { type: "goto", nodeId: "event3_ending" },
                ],
            },
            {
                key: "B",
                title: "征收庇古税（Pigouvian Tax），对每单位木材课重税",
                effects: [
                    { type: "add", key: "money", value: 400 },
                    { type: "add", key: "happiness", value: 5 },
                    { type: "add", key: "productivity", value: -5 },
                    {
                        type: "achievement",
                        id: "ach_pigouvian",
                        title: "庇古的算盘",
                        description: "税金充盈财政，伐木速度趋于均衡，水质缓慢恢复。将外部成本内部化——让污染者为自己的代价买单。",
                    },
                    { type: "log", text: "事件三：征收庇古税，财政收入增加，污染速度放缓。" },
                    { type: "goto", nodeId: "event3_ending" },
                ],
            },
            {
                ...
                title: "将河流产权私有化，卖给渔民",
                effects: [
                    { type: "add", key: "money", value: 200 },
                    { type: "add", key: "happiness", value: -5 },
                    { type: "add", key: "gdp", value: 50 },
                    {
                        type: "achievement",
                        id: "ach_coase_theorem",
                        title: "科斯的手",
                        description: "渔民获得产权后向伐木工索取污染赔偿，市场在剧烈博弈后自寻均衡。科斯定理：明晰产权，无需政府干预。",
                    },
                    { type: "log", text: "事件三：河流产权私有化，市场自发博弈，价格剧烈波动后趋于均衡。" },
                    { type: "goto", nodeId: "event3_ending" },
                ],
            },
        ],
    ...
    season3_end: {
        id: "season3_end", type: "dialogue", speaker: "（系统）", bg: "black",
        text: "【第三季 结束】\n公共资源的命运，取决于掌权者的选择。你的裁决已载入史册。",
        next: "season3_start",
    },
    season3_start: {
        id: "season3_start", type: "dialogue", speaker: "立（Prophet）", avatar: "🐴", bg: "village",
        text: "撑过第三季了。村庄在成长，麻烦也在成长。下一场风暴，来自技术……",
        next: "event4_start",
    },
    ...
    event4_choice: {
        ...
        choices: [
            {
                key: "A",
                title: "砸毁新农具，保住所有人的饭碗",
                effects: [
                    { type: "add", key: "unemploymentRate", value: -25 },
                    { type: "add", key: "happiness", value: 5 },
                    { type: "add", key: "techLevel", value: -0.2 },
                    { type: "add", key: "gdp", value: -100 },
                    {
                        type: "achievement",
                        id: "ach_luddite",
                        title: "卢德分子",
                        description: "农夫们欢呼雀跃，广场重归平静。但新农具的碎片里，埋葬的是这个村庄本可拥有的未来。技术水平永久回退。",
                    },
                    { type: "log", text: "事件四：砸毁农具，失业率归零，但科技水平回退，GDP永久受损。" },
                    { type: "goto", nodeId: "event4_ending" },
                ],
            },
            {
                key: "B",
                title: "对农场主征重税，发放失业救济金",
                effects: [
                    { type: "add", key: "money", value: -500 },
                    { type: "add", key: "happiness", value: -5 },
                    { type: "add", key: "unemploymentRate", value: 10 },
                    { type: "add", key: "gdp", value: -30 },
                    {
                        type: "achievement",
                        id: "ach_welfare_state",
                        title: "福利国家",
                        description: "失业者领到了救济金，暂时喘了口气。但财政支出的窟窿越来越大，赤字危机已在暗处蓄势。这是凯恩斯主义的温情，也是它的软肋。",
                    },
                    { type: "log", text: "事件四：发放救济金，happiness跌幅受控，但财政压力剧增。" },
                    { type: "goto", nodeId: "event4_ending" },
                ],
            },
            {
                ...
                effects: [
                    { type: "add", key: "happiness", value: -20 },
                    { type: "add", key: "population", value: -1 },
                    { type: "add", key: "productivity", value: 10 },
                    { type: "add", key: "gdp", value: 50 },
                    {
                        type: "achievement",
                        id: "ach_creative_destruction",
                        title: "创造性破坏",
                        description: "阵痛是真实的，哭声也是真实的。但熬过这个寒冬，失业者中诞生了铁匠、布匠和厨子——新的服务业就此萌芽。",
                    },
                    { type: "log", text: "事件四：放任市场清算，短期痛苦，但新产业自发涌现。" },
                    { type: "goto", nodeId: "event4_ending" },
                ],
            },
        ],
    ...
    season4_end: {
        id: "season4_end", type: "dialogue", speaker: "（系统）", bg: "black",
        text: "【第四季 结束】\n铁疙瘩改变了村庄的面貌，也改变了某些人的命运。历史不会为任何人倒退。",
        next: "season4_start",
    },
    season4_start: {
        id: "season4_start", type: "dialogue", speaker: "立（Prophet）", avatar: "🐴", bg: "village",
        text: "撑过第四季了。村子越来越大，交易越来越多，但用来交易的东西……还是那些沉甸甸的金属块。也许，是时候重新定义\"钱\"了。",
        next: "event5_start",
    },

    // ─── 事件五：法定货币的诞生与通货膨胀 ──────────────────────────────────
    event5_start: {
        id: "event5_start", type: "dialogue", speaker: "村民一（商贩）", avatar: "🛒", bg: "village",
        text: "河对岸的物资进不来，没有桥，我们迟早要困死在这里！村长，大家都很信任你，只要你拿纸盖个章当钱用，先把造桥的料买回来，以后的日子肯定能好起来的！",
        next: "event5_dialogue_2",
    },
    event5_dialogue_2: {
        id: "event5_dialogue_2", type: "dialogue", speaker: "村民二（寡妇）", avatar: "👵", bg: "village",
        ...
        choices: [
            {
                ...
                effects: [
                    ...
                    { type: "add", key: "gdp", value: 150 },
                    { type: "add", key: "cpi", value: 20 },
                    { type: "add", key: "happiness", value: -5 },
                    {
                        type: "achievement",
                        id: "ach_money_printer",
                        title: "印钞机轰鸣",
                        description: "桥建好了，货物滚滚而来。但寡妇发现她攒的铜板，买不到以前一半的东西了。通货膨胀——文明最隐秘的税收。",
                    },
                    { type: "log", text: "事件五：量化宽松，GDP大涨，但CPI飙升，购买力受损。" },
            ...
            },
            {
                ...
                effects: [
                    { type: "add", key: "happiness", value: 5 },
                    { type: "add", key: "cpi", value: -5 },
                    { type: "add", key: "gdp", value: -50 },
                    {
                        type: "achievement",
                        id: "ach_gold_standard",
                        title: "硬通货的尊严",
                        description: "寡妇的铜板保住了购买力，村民对货币充满信任。但桥，依然没有建起来，河对岸的繁荣与这座村庄无缘。",
                    },
                    { type: "log", text: "事件五：坚守硬通货，CPI稳定，但桥梁搁置，GDP停滞。" },
                    { type: "goto", nodeId: "event5_ending" },
                ],
            },
            {
                ...
                title: "强制没收富裕商人的资产建桥",
                effects: [
                    { type: "add", key: "money", value: 800 },
                    { type: "add", key: "gdp", value: 100 },
                    { type: "add", key: "productivity", value: -15 },
                    { type: "add", key: "happiness", value: -5 },
                    {
                        type: "achievement",
                        id: "ach_expropriation",
                        title: "征用令",
                        description: "桥建好了，CPI纹丝不动。但商人们的眼神变了——谁还敢在这里积累财富？私人投资意愿跌入冰点。",
                    },
                    { type: "log", text: "事件五：没收资产建桥，无通胀，但商人productivity暴跌。" },
                    { type: "goto", nodeId: "event5_ending" },
                ],
            },
        ],
    ...
    season5_end: {
        id: "season5_end", type: "dialogue", speaker: "（系统）", bg: "black",
        text: "【第五季 结束】\n货币的形态已然改变，但贪婪与恐惧从未改变。",
        next: "season5_start",
    },
    season5_start: {
        id: "season5_start", type: "dialogue", speaker: "立（Prophet）", avatar: "🐴", bg: "village",
        text: "撑过第五季了。村庄的市场越来越繁荣，但繁荣吸引了一种危险的生物——垄断者。",
        next: "event6_start",
    },

    // ─── 事件六：垄断力量与价格管制 ──────────────────────────────────────────
    event6_start: {
        id: "event6_start", type: "dialogue", speaker: "村民一（农夫）", avatar: "👨‍🌾", bg: "village",
        text: "三倍！一把破铁锄头他居然敢要三倍的价钱！他这是在喝我们的血！村长，你是我们的父母官，你要是再不管管这黑心商人，我们只能拿起石头跟他去拼命了！",
        next: "event6_dialogue_2",
    },
    event6_dialogue_2: {
        id: "event6_dialogue_2", type: "dialogue", speaker: "村民二（矿主）", avatar: "⛏️", bg: "village",
    ...
    event6_choice: {
        ...
        choices: [
            {
                key: "A",
                title: "颁布限价令，强行压低工具价格",
                effects: [
                    { type: "add", key: "happiness", value: 10 },
                    { type: "add", key: "productivity", value: -20 },
                    { type: "add", key: "actionPoints", value: -1 },
                    { type: "add", key: "gdp", value: -80 },
                    {
                        type: "achievement",
                        id: "ach_price_ceiling",
                        title: "限价令",
                        description: "农夫笑了，矿主停工了。价格压下去了，工具却消失了。供需曲线上，那片无谓损失（Deadweight Loss）触目惊心。",
                    },
                    { type: "log", text: "事件六：颁布限价令，工具短缺，GDP大跌，需消耗AP维持秩序。" },
                    { type: "goto", nodeId: "event6_ending" },
                ],
            },
            {
                key: "B",
                title: "官方出资勘探新矿，扶持竞争者",
                effects: [
                    { type: "add", key: "money", value: -600 },
                    { type: "add", key: "gdp", value: 100 },
                    { type: "add", key: "happiness", value: 5 },
                    {
                        type: "achievement",
                        id: "ach_antitrust",
                        title: "反垄断战争",
                        description: "国库大出血，但竞争回来了。新矿山的铁，把垄断者从神坛上拉了下来。市场均衡，用公帑买的。",
                    },
                    { type: "log", text: "事件六：扶持竞争者，国库大出血，但垄断被打破，GDP长期受益。" },
                    { type: "goto", nodeId: "event6_ending" },
                ],
            },
            {
                key: "C",
                title: "不加干涉，保护商人的绝对定价权",
                effects: [
                    { type: "add", key: "happiness", value: -10 },
                    { type: "add", key: "productivity", value: -10 },
                    { type: "add", key: "money", value: 300 },
                    { type: "add", key: "gdp", value: 50 },
                    {
                        ...
                        id: "ach_trickle_down",
                        title: "涓滴效应",
                        description: "农民在痛苦中熬着，矿主的财富堆成山。终于，他把钱投向了村庄的道路建设——涓滴效应，迟到的正义。",
                    },
                    { type: "log", text: "事件六：放任垄断，农民短期极度痛苦，但资本积累后流回村庄。" },
                    { type: "goto", nodeId: "event6_ending" },
                ],
            },
        ],
    ...
    season6_end: {
        id: "season6_end", type: "dialogue", speaker: "（系统）", bg: "black",
        text: "【第六季 结束】\n权力与资本的角力，从未停歇。",
        next: "season6_start",
    },
    season6_start: {
        id: "season6_start", type: "dialogue", speaker: "立（Prophet）", avatar: "🐴", bg: "village",
        text: "撑过第六季了。冬天来了……一场格外凶猛的暴风雪，正在路上。",
        next: "event7_start",
    },

    // ─── 事件七：宏观冲击与总需求不足 ───────────────────────────────────────
    event7_start: {
        id: "event7_start", type: "dialogue", speaker: "村民一（餐厅老板）", avatar: "🍜", bg: "village",
        text: "村长，求求你救救我！大雪封路，连着半个月一个客人都没有，伙计们的工钱根本发不出！如果明天再没有进项，我就只能去跳冰窟窿了！",
        next: "event7_dialogue_2",
    },
    event7_dialogue_2: {
        id: "event7_dialogue_2", type: "dialogue", speaker: "村民二（守财奴）", avatar: "💰", bg: "village",
        ...
        choices: [
            {
                ...
                effects: [
                    ...
                    { type: "add", key: "gdp", value: 100 },
                    { type: "add", key: "happiness", value: 15 },
                    { type: "add", key: "cpi", value: 10 },
                    {
                        type: "achievement",
                        id: "ach_helicopter_money",
                        title: "直升机撒钱",
                        description: "消费券发出去，餐厅活下来了，GDP企稳了。但物价悄悄涨上去了——凯恩斯主义托底总需求，代价是日后的通胀。",
                    },
                    { type: "log", text: "事件七：发放消费券，GDP企稳，happiness回升，但CPI上涨。" },
                    { type: "goto", nodeId: "event7_ending" },
                ],
            },
            {
                key: "B",
                title: "任由餐厅破产，等待物价自然下跌",
                effects: [
                    { type: "add", key: "unemploymentRate", value: 15 },
                    { type: "add", key: "happiness", value: -15 },
                    { type: "add", key: "cpi", value: -10 },
                    { type: "add", key: "gdp", value: -100 },
                    {
                        type: "achievement",
                        id: "ach_liquidationist",
                        title: "清算主义者",
                        description: "餐厅倒了，失业者流落街头。但通货紧缩之后，物价回落，经济结构在剧痛中完成了自我修复。奥地利学派的处方，又苦又烈。",
                    },
                    { type: "log", text: "事件七：放任破产，失业率飙升，通货紧缩，但结构性修复开始。" },
                    { type: "goto", nodeId: "event7_ending" },
                ],
            },
            {
                ...
                effects: [
                    ...
                    {
                        type: "achievement",
                        id: "ach_nationalization",
                        title: "国有化",
                        description: "餐厅没有倒，伙计们的工钱照发。但从今往后，这里每一道菜都要经过村长办公室审批。官僚主义的成本，你还没开始计算。",
                    },
                    { type: "log", text: "事件七：餐厅国有化，失业率为零，但每季消耗额外AP与资金。" },
                    { type: "goto", nodeId: "event7_ending" },
                ],
            },
        ],
    ...
    season7_end: {
        id: "season7_end", type: "dialogue", speaker: "（系统）", bg: "black",
        text: "【第七季 结束】\n暴风雪终于过去了。但那些在寒冬中消失的餐厅，不会再回来了。",
        next: "season7_start",
    },
    season7_start: {
        id: "season7_start", type: "dialogue", speaker: "立（Prophet）", avatar: "🐴", bg: "village",
        text: "撑过第七季了。春暖花开，但村里传来消息——瘟疫的阴影，正从远方逼近。",
        next: "event8_start",
    },

    // ─── 事件八：税收政策与公共产品 ──────────────────────────────────────────
    event8_start: {
        id: "event8_start", type: "dialogue", speaker: "村民一（劳工）", avatar: "⛏️", bg: "village",
        text: "瘟疫来了大家都要死！凭什么让我们这些饭都吃不饱的人，去跟那些住大房子的大财主交一样的钱？他们拔一根汗毛都比我们的腰粗！",
        next: "event8_dialogue_2",
    },
    event8_dialogue_2: {
        id: "event8_dialogue_2", type: "dialogue", speaker: "村民二（富商）", avatar: "🤵", bg: "village",
        ...
        choices: [
            {
                ...
                effects: [
                    ...
                    {
                        type: "achievement",
                        id: "ach_progressive_tax",
                        title: "北欧之梦",
                        description: "水井建成，瘟疫解除。底层村民奔走相告，富商则暗暗心寒。二次分配缩小了贫富差距，但商业投资意愿，已悄然下滑。",
                    },
                    { type: "log", text: "事件八：累进税制，水井建成，瘟疫解除，底层happiness大涨，但GDP增速下滑。" },
                    { type: "goto", nodeId: "event8_ending" },
                ],
            },
            {
                key: "B",
                title: "实施人头税，所有人交同等金额",
                effects: [
                    { type: "add", key: "gdp", value: 50 },
                    { type: "add", key: "happiness", value: -10 },
                    { type: "add", key: "productivity", value: 10 },
                    {
                        ...
                        id: "ach_flat_tax",
                        title: "税制中性",
                        description: "水井建成，瘟疫解除。富商对税制满意，资本继续积累。但贫农的负担压垮了腰，阶层的裂缝，又深了一寸。",
                    },
                    { type: "log", text: "事件八：人头税，水井建成，商业资本积累，但贫农税负沉重。" },
                    { type: "goto", nodeId: "event8_ending" },
                ],
            },
            {
                ...
                effects: [
                    ...
                    { type: "add", key: "gdp", value: -80 },
                    {
                        ...
                        id: "ach_free_rider",
                        title: "搭便车者",
                        description: "众筹失败了。每个人都等着别人先捐。水井没建成，瘟疫来了。财产权得到了捍卫，但代价是三条人命。这叫搭便车问题（Free Rider Problem）。",
                    },
                    { type: "log", text: "事件八：众筹失败，瘟疫爆发，人口锐减，财产权得到捍卫但代价惨重。" },
                    { type: "goto", nodeId: "event8_ending" },
                ],
            },
        ],
    ...
    season8_end: {
        id: "season8_end", type: "dialogue", speaker: "（系统）", bg: "black",
        text: "【第八季 结束】\n公平与效率的博弈，没有终点。你的选择，定义了这座村庄的灵魂。",
        next: "season8_start",
    },
    season8_start: {
        id: "season8_start", type: "dialogue", speaker: "立（Prophet）", avatar: "🐴", bg: "village",
        text: "撑过第八季了。村庄的边界，已经不够用了。山那边，有另一座村庄在招手……",
        next: "event9_start",
    },

    // ─── 事件九：国际贸易与比较优势 ──────────────────────────────────────────
    event9_start: {
        id: "event9_start", type: "dialogue", speaker: "村民一（本地铁匠）", avatar: "🔨", bg: "village",
        text: "村长！我祖上三代都在这里打铁！你现在要是让那些外村人的便宜铁器进来，我的炉子就得熄火，老婆孩子都要流落街头啊！你忍心看着本村人饿死在外人手里吗？",
        next: "event9_dialogue_2",
    },
    event9_dialogue_2: {
        id: "event9_dialogue_2", type: "dialogue", speaker: "村民二（农民代表）", avatar: "🌾", bg: "village",
        ...
        choices: [
            {
                ...
                effects: [
                    ...
                    {
                        type: "achievement",
                        id: "ach_protectionism",
                        title: "锁国令",
                        description: "铁匠的炉火没有熄灭。但村民们继续用着笨重的旧工具，效率低下，与山外的繁荣渐行渐远。保护，是有代价的温柔。",
                    },
                    { type: "log", text: "事件九：贸易禁令，铁匠铺保住，但农业效率低下，GDP停滞。" },
            ...
            },
            {
                ...
                effects: [
                    ...
                    { type: "add", key: "productivity", value: 5 },
                    {
                        ...
                        id: "ach_tariff",
                        title: "关税壁垒",
                        description: "国库丰盈，铁匠铺勉强维持，农民也得到了半价工具。没有人完全满意，没有人彻底受损——这就是妥协的艺术。",
                    },
                    { type: "log", text: "事件九：征收关税，国库收入，铁匠铺生存，农业生产力部分提升。" },
                    { type: "goto", nodeId: "event9_ending" },
                ],
            },
            {
                ...
                effects: [
                    ...
                    {
                        type: "achievement",
                        id: "ach_comparative_advantage",
                        title: "比较优势",
                        description: "铁匠铺的炉火熄灭了，村里爆发了一波失业潮。但粮仓满得快溢出来，GDP飙升。李嘉图是对的——但他没有告诉你，该怎么面对那个失业的铁匠。",
                    },
                    { type: "log", text: "事件九：全面自由贸易，铁匠铺倒闭，失业潮，但小麦产量与GDP指数级爆发。" },
                    { type: "goto", nodeId: "event9_ending" },
                ],
            },
        ],
    ...
    season9_end: {
        id: "season9_end", type: "dialogue", speaker: "（系统）", bg: "black",
        text: "【第九季 结束】\n边界打开了，机遇与威胁一同涌入。",
        next: "season9_start",
    },
    season9_start: {
        id: "season9_start", type: "dialogue", speaker: "立（Prophet）", avatar: "🐴", bg: "village",
        text: "撑过第九季了。但邻村做了一件卑鄙的事——他们动了货币。这是最后的决战了，村长。",
        next: "event10_start",
    },

    // ─── 事件十：汇率战与宏观博弈 ────────────────────────────────────────────
    event10_start: {
        id: "event10_start", type: "dialogue", speaker: "村民一（小麦出口商）", avatar: "📦", bg: "village",
        text: "村长，隔壁村太不要脸了，把他们钱的价值贬得一文不值！咱们的麦子现在在那边卖得比金子还贵，根本没人买！粮仓都要发霉了，我们只能以牙还牙跟着贬值啊！",
        next: "event10_dialogue_2",
    },
    event10_dialogue_2: {
        id: "event10_dialogue_2", type: "dialogue", speaker: "村民二（普通消费者）", avatar: "🧑", bg: "village",
        ...
        choices: [
            {
                ...
                title: "针锋相对，主动贬值本村货币",
                effects: [
                    { type: "add", key: "foodStock", value: -20 },
                    { type: "add", key: "gdp", value: 80 },
                    { type: "add", key: "cpi", value: 15 },
                    { type: "add", key: "happiness", value: -5 },
                    {
                        type: "achievement",
                        id: "ach_currency_war",
                        title: "以牙还牙",
                        description: "出口恢复了，滞销的麦子终于卖出去了。但每个村民口袋里的钱，也悄悄缩水了。竞争性贬值——一场没有赢家的底线竞争。",
                    },
                    { type: "log", text: "事件十：主动贬值，出口恢复，但输入型通胀爆发，CPI飙升。" },
            ...
            },
            {
                ...
                effects: [
                    ...
                    {
                        type: "achievement",
                        id: "ach_strong_currency",
                        title: "货币的尊严",
                        description: "出口行业哀鸿遍野，但每一枚铜板的购买力，都坚挺如初。强势货币，是无声的宣言：我们不参与这场竞相堕落的游戏。",
                    },
                    { type: "log", text: "事件十：维持强势汇率，出口崩溃，但村民实际购买力大幅提升。" },
                    { type: "goto", nodeId: "event10_ending" },
                ],
            },
            {
                key: "C",
                title: "强行建立货币联盟，与邻村统一货币",
                effects: [
                    { type: "add", key: "money", value: -800 },
                    { type: "add", key: "actionPoints", value: -2 },
                    { type: "add", key: "gdp", value: 120 },
                    { type: "add", key: "happiness", value: 5 },
                    {
                        type: "achievement",
                        id: "ach_monetary_union",
                        title: "货币同盟",
                        description: "汇率战永久终结，贸易畅通无阻。但代价是，你再也无法用印钞来解决任何国内危机了。权力，有时候需要你亲手交出去，才能换来真正的稳定。",
                    },
                    { type: "log", text: "事件十：建立货币联盟，汇率消除，贸易长期繁荣，但丧失货币主权。" },
                    { type: "goto", nodeId: "event10_ending" },
                ],
            },
        ],
